...
CREATE TABLE formacion_academica.dato_adicional_formacion_academica (
	...
	valor text NOT NULL,
	formacion_academica_id integer NOT NULL,
...
-- ddl-end --
COMMENT ON TABLE formacion_academica.soporte_formacion_academica IS 'Tabla que almacena los soportes correspondientes a una formacion laboral';
-- ddl-end --
...
ALTER TABLE formacion_academica.soporte_formacion_academica ADD CONSTRAINT fk_soporte_formacion_academica_formacion_academica FOREIGN KEY (formacion_academica_id)
...
ALTER TABLE formacion_academica.dato_adicional_formacion_academica ADD CONSTRAINT fk_dato_adicional_formacion_academica_formacion_academica FOREIGN KEY (formacion_academica_id)
REFERENCES formacion_academica.formacion_academica (id) MATCH FULL
ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --